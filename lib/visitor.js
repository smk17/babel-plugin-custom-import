 ...
 * @LastEditTime: 2019-05-30 15:07:06
 */
/**
 * @file visitor
...
const visitor = {
  ...
  ImportDeclaration: {
    ...
    exit(path, source) {
      let {
        opts: { externalScheme, syncFunc, isReplaceScheme }
      } = source;
